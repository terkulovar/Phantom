...
//	virtual void ConstructSDandField() override;
        ...
        G4double GetTotalMass() { return fTetData->GetTotalMass(); };
...
private:
	...
	G4LogicalVolume*   fTetLogic;
        Materials*         materials;
        G4Material* composite_mat, *alum_mat, *polyprop_mat, *lif_mat, *world_mat;
        G4Material* steel_mat, *iss_mat, *water_mat;
        G4double alum_sizeZ, steel_sizeZ, polyprop_sizeZ, polyprop_sizeZ1;
        G4double composite_Rmax, composite_Rmin, composite_thickness, composite_sizeZ;
        G4double lif_R, lif_H;
};
#endif
