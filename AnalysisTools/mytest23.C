...
// gPad->SetLogy();
 ...
 delete in;
 ii = 0;
 in = new ifstream("../data/spenvis_trapped_protons_2025_372km_51.6degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_trapped_protons_2025_372km_96.8degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_trapped_protons_2025_420km_96.8degree_min_diff.txt", ios::in);
 while (1)
 {
  *in >> en >> vTrap_p;
 ...
 delete in;
 ii = 0;
 in = new ifstream("../data/spenvis_GCR_H_2025_372km_51.6degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_H_2025_372km_96.8degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_H_2025_420km_96.8degree_min_diff.txt", ios::in);
 while (1)
 {
//  *in >> en >> vHmin >> vHemin >> vLimin;
 ...
 delete in;
 ii = 0;
 in = new ifstream("../data/spenvis_GCR_He_2025_372km_51.6degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_He_2025_372km_96.8degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_He_2025_420km_96.8degree_min_diff.txt", ios::in);
 while (1)
 {
  *in >> en >> vHemin;
  if (!in->good() || in->eof() ) {
 ...
 delete in;
 ii = 0;
 in = new ifstream("../data/spenvis_GCR_C_2025_372km_51.6degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_C_2025_372km_96.8degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_C_2025_420km_96.8degree_min_diff.txt", ios::in);
 while (1)
 {
  *in >> en >> vCmin;
  if (!in->good() || in->eof() ) {
 ...
 delete in;
 ii = 0;
 in = new ifstream("../data/spenvis_GCR_O_2025_372km_51.6degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_O_2025_372km_96.8degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_O_2025_420km_96.8degree_min_diff.txt", ios::in);
 while (1)
 {
  *in >> en >> vOmin;
  if (!in->good() || in->eof() ) {
 ...
 delete in;
 ii = 0;
 in = new ifstream("../data/spenvis_GCR_Fe_2025_372km_51.6degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_Fe_2025_372km_96.8degree_min_diff.txt", ios::in);
// in = new ifstream("../data/spenvis_GCR_Fe_2025_420km_96.8degree_min_diff.txt", ios::in);
 while (1)
 {
  *in >> en >> vFemin;
  if (!in->good() || in->eof() ) {
...
// mg->GetYaxis()->SetRangeUser(1.e-6, 2.e8);
 mg->GetYaxis()->SetRangeUser(5.e-7, 2.e8);
